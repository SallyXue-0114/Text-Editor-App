  ...
  private: //✅
    ...
    Label transparencyLabel{"Transparency"};
    ...
    std::vector<Colour> colors{juce::Colours::navy, juce::Colours::purple, juce::Colours::brown, juce::Colours::darkgreen, juce::Colours::black};
